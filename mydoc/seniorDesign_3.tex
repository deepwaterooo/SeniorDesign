...
\caption{Base Version Software Interface}
\end{figure}
\end{itemize}
...
\begin{itemize}
\item GUI Layout Selection: We have been proposed two GUI designs, snapshots when we discussed about them, which are listed as followed Figure 3 \& Figure 4. 
\begin{figure}[htb]
\centering
\includegraphics[width=.8\linewidth]{../pic/Screenshot_from_2014-12-02_22:43:29_one.png}
...
\end{figure}
The Tower Light Animator can be described in five different modules, as drawing listed in above Figure 5 - System Architecture High Level Model: 
\begin{itemize}
...
\begin{figure}[htb]
\centering
\includegraphics[width=.8\linewidth]{../pic/Screenshot_from_2014-12-02_19:22:35.png}
\caption{Main Windows}
\end{figure}
\item Pop-up Window
\begin{figure}[htb]
\centering
\includegraphics[width=.5\linewidth]{../pic/Screenshot_from_2014-11-27_23:34:06.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=.8\linewidth]{../pic/guiClass.jpg}
...
\item Audio file parse to generate consistence for timestamps incremental amount, a basic intuitive layout is listed as below presented in Figure 10, which has a timestamps double spin-box to show the detailed time and parsed wave drawing picture: 
\begin{figure}[htb]
\centering
