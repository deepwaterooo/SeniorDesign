...
\subsection{11/21/2014: \textbf{Global Agreement - Graduate}}
\label{sec-2-1}
\begin{itemize}
...
\item Use picture ./pic/2014-11-21$_{\text{17}}$:20:11$_{\text{GlobalAgreementGraduate}}$.png to set a mark there;
\end{itemize}

\subsection{0.6 11/21/2014, \textbf{Global Agreement - Graduate}, updates include}
\label{sec-2-2}
\begin{itemize}
