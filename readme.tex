...
\section{Updates}
\label{sec-2}
I kept an original version of my \textbf{buttons$_{\text{bk}}$.h} and \textbf{buttons$_{\text{bk}}$.cpp} file for reference as they are the best indication of my problem-solving skills, because I didn't remove any trial that I have tried in order to solve my Problems.
...
\includegraphics[width=.6\linewidth]{./pic/IMG_0169.JPG}

\includegraphics[width=.6\linewidth]{./pic/IMG_0167.JPG}
