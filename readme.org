...
- worked on the documents a little bit; From very beginning I never liked to write the document, but still even after I have put hard work on it, I still needs to finish the software design document according to requirement even individually. 
